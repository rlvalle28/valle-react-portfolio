          ...
          <div className='CardContainer d-flex justify-content-center align-items-center flex-wrap gap-4'>
            ...
            <div className='Card d-flex flex-column'>
              ...
              <div className='cardBottom mt-2'>
                <IoMdStar /><IoMdStar /><IoMdStar /><IoMdStarHalf /><IoMdStarOutline />
              </div>
              <div className='rate'>
            ...
            <div className='Card d-flex flex-column'>
              ...
              <div className='cardBottom m-2'>
                <IoMdStar /><IoMdStar /><IoMdStarHalf /><IoMdStarOutline /><IoMdStarOutline />
              </div>
              <div className='rate'>
            ...
            <div className='Card d-flex flex-column'>
              <div className='cardTop'>
                <img src={bootstrap_img} alt="Bootstrap logo" />
              </div>
            ...
            <div className='Card d-flex flex-column'>
              <div className='cardTop'>
                <img src={wp_img} alt="WordPress logo" />
              </div>
              <div className='cardBottom'>
                <IoMdStar /><IoMdStar /><IoMdStar /><IoMdStarHalf /><IoMdStarOutline />
              </div>
